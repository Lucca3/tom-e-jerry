...
function draw() {
  ...
  if (retMovimento.x - retFixo.x < retFixo.width/2 + retMovimento.width/2 &&
    retFixo.x - retMovimento.x < retFixo.width/2 + retMovimento.width/2 &&
    retMovimento.y - retFixo.y < retFixo.height/2 + retMovimento.height/2 &&
    retFixo.y - retMovimento.y < retFixo.height/2 + retMovimento.height/2){
